...
const Flex7 = () => {
    ...
    useEffect(() => {
        if (justifyContent.toLowerCase() == 'space-evenly' && alignItems.toLowerCase() == 'center' && flexDirection.toLowerCase() == 'column') {
            setButton(true)
        }
        ...
        <div className='main7'>
            ...
            <div className="gameContainer7">
                <div className='container7' >
                    <div className="object7" style={{ display: 'flex', gap: '10px', justifyContent: `${justifyContent}`, alignItems: `${alignItems}`, flexDirection: `${flexDirection}` }}>
                ...
                <div className='inputContainer7'>
                    ...
                    {button ? <div id='level'><h1>Hurray! Level 7 completed</h1><Link to='/Smart-Learning/Css/Flex/Flex8'><button id='nextLevel'>Next Level &#129034;</button></Link></div> : ''}

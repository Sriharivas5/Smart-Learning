...
const Flex = () => {
    ...
    useEffect(() => {
        if (justifyContent.toLowerCase() == 'flex-end' && alignItems.toLowerCase() == 'center') {
            setButton(true)
        }
        ...
        <div className='main'>
            ...
            <div className="gameContainer">
                ...
                <div className='inputContainer'>
                    ...
                    {button ? <div id='level'><h1>Hurray! Level 1 completed</h1><Link to='/Smart-Learning/Css/Flex/Flex2'><button id='nextLevel'>Next Level &#129034;</button></Link></div> : ''}

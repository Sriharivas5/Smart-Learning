...
const Flex2 = () => {
    ...
    useEffect(() => {
        if (justifyContent.toLowerCase() == 'center' && alignItems.toLowerCase() == 'center') {
            setButton(true)
        }
        ...
        <div className='main2'>
            ...
            <div className='gameContainer2'>
                <div className='container2' >
                    <div className="object2" style={{ display: 'flex', gap: '10px', justifyContent: `${justifyContent}`, alignItems: `${alignItems}` }}>
                        <img src={mario} alt="" />
                    </div>
                    <div className="land2">
                        <img src={bricks} />
                ...
                <div className='inputContainer2'>
                    ...
                    <div className='inputHeadings2'>
                        ...
                        <h3>Justify-Content: <span>center, flex-start, flex-end</span> </h3>
                    ...
                    {button ? <div id='level'><h1>Hurray! Level 2 completed</h1><Link to='/Smart-Learning/Css/Flex/Flex3'><button id='nextLevel'>Next Level &#129034;</button></Link></div> : ''}
                </div>
            </div>
        </div>
    )

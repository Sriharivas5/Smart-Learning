...
const Flex3 = () => {
    ...
    useEffect(() => {
        if (justifyContent.toLowerCase() == 'space-between' && alignItems.toLowerCase() == 'center') {
            setButton(true)
        }
        ...
        <div className='main3'>
            ...
            <div className="gameContainer3">
                <div className='container3' >
                    <div className="object3" style={{ display: 'flex', gap: '10px', justifyContent: `${justifyContent}`, alignItems: `${alignItems}` }}>
                        <img src={mario}  />
                        <img src={mario}  />
                ...
                <div className='inputContainer3'>
                    ...
                    {button ? <div id='level'><h1>Hurray! Level 3 completed</h1><Link to='/Smart-Learning/Css/Flex/Flex4'><button id='nextLevel'>Next Level &#129034;</button></Link></div> : ''}

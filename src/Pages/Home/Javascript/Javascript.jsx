...
const Javascript = () => {
  ...
  return (
    ...
    <h1>Introduction</h1>
    <p>JavaScript is a dynamic programming language primarily used for adding interactivity to web pages. Its versatility extends to server-side development, mobile apps, and more. With a syntax resembling C-style languages, JavaScript's event-driven nature and vast ecosystem of libraries make it a cornerstone of modern web development.</p>

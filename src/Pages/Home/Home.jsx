  ...
  return (
    <div className='home'>
      ...
      <div className="css">
        ...
        <Link to='/Smart-Learning/Css'><button>Start the Adventure! </button></Link>
      </div>
      <div className="js">
        ...
        <Link to='/Smart-Learning/js'><button>Ready to Play! </button></Link>
      </div>
      <div className="reactJs">
        ...
        <Link to='/Smart-Learning/Css'><button>Start Exploring! </button></Link>
      </div>
      {/* <h1>css</h1> */}
